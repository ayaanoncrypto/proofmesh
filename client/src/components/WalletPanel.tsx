    ...
    <Card className="border-cyan-200 bg-cyan-50/50">
      ...
      <CardContent>
        {!wallet ? (
          ...
          <div className="space-y-3">
            <div className="rounded-xl border border-emerald-100 bg-emerald-50/60 px-3 py-2 text-xs text-emerald-800">Connected to Arbitrum Sepolia. All balances and transactions below use testnet assets. If a transaction requests Routeme, repair the wallet RPC before retrying.</div>
